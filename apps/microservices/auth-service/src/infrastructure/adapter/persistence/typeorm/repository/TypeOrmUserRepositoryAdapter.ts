...
import { TypeOrmUserMapper } from '@infrastructure/adapter/persistence/typeorm/mapper/TypeOrmUserMapper';
import { TypeOrmUser } from '@infrastructure/adapter/persistence/typeorm/entity/TypeOrmUser';
import { InsertResult, SelectQueryBuilder, Repository } from 'typeorm';
...
export class TypeOrmUserRepositoryAdapter implements UserRepositoryPort {
  ...
  public async findUser(
    ...
    const ormEntity: TypeOrmUser | null = await query.getOne();
