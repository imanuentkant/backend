...
export interface PostRepositoryPort {
  ...
  addPostMedia?(postMedia: any): Promise<void>;
  removePostMedia?(postId: string, mediaId: string): Promise<void>;
  updatePostMediaOrder?(postId: string, mediaOrders: { mediaId: string; sortOrder: number }[]): Promise<void>;
